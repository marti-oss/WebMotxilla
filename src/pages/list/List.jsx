...
function taula(){
    ...
    if (url.match("monitor")) return (
        <div>
            <h1>Monitors</h1>
            <Datatable rows={rowsMonitors} columns={columnsMonitors}/>
        </div>
        );

    if (url.match("nen")) return(<div>
        <h1>Nens</h1>
    ...
    if (url.match("equip")) return (
        <div>
            <h1>Equips</h1>
            <Datatable rows={rowsEquips} columns={columnsEquips}/>
        </div>
